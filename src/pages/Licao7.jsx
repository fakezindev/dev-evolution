    ...
    <div className="ide-new-container">
      ...
      <div className="ide-new-sidebar">
        ...
        <div className="ide-new-box purple">
          <h4>📚 TEORIA</h4>
          <p>
            Às vezes não precisamos de uma encruzilhada (if/else), precisamos apenas de um "alarme".<br/><br/>
            Por exemplo: nós só queremos dar uma multa <strong>SE</strong> (if) o carro passar do limite. 
            Se ele estiver na velocidade certa, não fazemos absolutamente nada (não precisa de else!). O <strong>if</strong> pode viver sozinho feliz e contente.
          </p>
        </div>
        ...
        <div className="ide-new-box">
          ...
          <ol>
             ...
             <li>Não crie nenhum <code>else</code>. Se ele estiver a 80 ou menos, deixe-o ir em paz!</li>
          </ol>
        </div>
      </div>
