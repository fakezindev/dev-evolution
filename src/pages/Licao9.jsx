    ...
    <div className="ide-new-container">
      ...
      <div className="ide-new-sidebar">
        ...
        <div className="ide-new-box purple">
          <h4>📚 TEORIA</h4>
          <p>
            O <strong>for</strong> (Para) é o irmão organizado do while. Ele é um laço de repetição perfeito para quando já sabemos exatamente onde a contagem começa e onde termina.<br/><br/>
            Ele tem 3 partes na sua declaração:<br/>
            1. Onde ele nasce (ex: <code>let i = 1</code>)<br/>
            2. Até onde ele vive (ex: <code>i &lt;= 10</code>)<br/>
        ...
        <div className="ide-new-box">
          <h4>🎯 MISSÃO</h4>
          <p style={{marginBottom: "10px"}}>Gere a tabuada usando um ciclo organizado!</p>
          <ol>
             <li>Crie a estrutura <code>for (let i = 1; i &lt;= 10; i++)</code>.</li>
             <li>Dentro do bloco do <code>for</code>, imprima no console a multiplicação do seu número base pela variável <code>i</code>.</li>
             <li>Execute e veja o ciclo acontecer em um piscar de olhos!</li>
          </ol>
        </div>
      </div>
