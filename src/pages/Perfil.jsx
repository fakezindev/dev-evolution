      ...
      <div className="perfil-header">
        ...
        <div className="perfil-info">
          ...
          <div style={{ margin: "15px 0", display: "flex", gap: "10px", alignItems: "center", justifyContent: "center" }}>
            <label style={{color: "#8a8a9e", fontWeight: "bold"}}>Cor do Perfil:</label>
            <input 
              type="color" 
              value={usuario.corPersonalizada || "#1da950"} 
              onChange={async (e) => {
                 ...
                 try {
                   await fetch("http://localhost:8080/api/alunos/atualizar-cor", {
                     ...
                     body: JSON.stringify({ corPersonalizada: novaCor })
                   });
                   // Opcional: injetar a cor globalmente
              ...
              style={{
                width: "40px", height: "40px", border: "none", borderRadius: "8px", cursor: "pointer", background: "transparent"
              }}
            />
          </div>
