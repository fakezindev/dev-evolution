      ...
      <div className="ide-new-sidebar">
        ...
        <div className="ide-new-box purple">
          ...
          <p>
            ...
            No JavaScript, a forma de fazer o computador escrever algo na tela é usando um comando chamado <strong>console.log()</strong>. 
            <br/><br/>
            Pense nele como o <strong>megafone do computador</strong>! Tudo que colocamos entre os parênteses, ele grita de volta para nós.
          </p>
        </div>

        <div className="ide-new-box">
          <h4>🎯 MISSÃO</h4>
          <p style={{marginBottom: "10px"}}>Faça o seu primeiro programa da história!</p>
          <ol>
             <li>Escreva o comando <strong>console.log("Olá, Mundo!")</strong> no editor de código à direita.</li>
             <li>Não esqueça das <strong>aspas</strong> (" ")! Elas dizem ao computador que você está escrevendo um texto.</li>
             <li>Clique no botão <strong>EXECUTAR</strong>.</li>
          </ol>
        </div>
      </div>
